...
const Education = () => {
    const Parcours = [{school:'EPKMA',year:2022,diplome:'Baccalaureat'},
        ...
        {school:'ESP)',year:"2024-2025",diplome:'Licence en Génie Logiciel & Systemes d\'Information'},
    ...
    return(
        ...
        {Parcours.map(parcours => (
            <div className="bg-amber-300 flex w-100 flex-col  text-center  mt-10 p-5 rounded-4xl relative">
                ...
                <h3 className='absolute flex flex-row items-end bottom-0  m-0'>School: {parcours.school} </h3>
