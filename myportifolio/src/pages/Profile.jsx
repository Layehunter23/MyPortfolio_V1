const Profile = () => {
    return(
    <>
    <div className="flex flex-row justify-center items-center mt-25 text-center gap-10 max-sm:flex-col" id="profile">
    <img className='h-100 w-100 rounded-3xl max-sm:justify-center' src='mytof2.jpg' alt="Ma photo"></img>
    <div className="flex flex-col">
    <h2 className="text-blue-100">Hello, I'm  <span className="text-fuchsia-600 text-2xl" >Papa Abdoulaye BARRY</span></h2>
