const Profile = () => {
    ...
    <h2 className="text-blue-100 text-2xl">Welcome to my page, I'm  <span className="typing text-amber-400 text-2xl" >Papa Abdoulaye BARRY</span></h2>
    <h2 className="text-blue-100 text-2xl">I'm a Software Developer</h2>
